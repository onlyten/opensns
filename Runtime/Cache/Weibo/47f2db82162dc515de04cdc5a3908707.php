<?php if (!defined('THINK_PATH')) exit();?><div style="max-width: 680px;margin-bottom: 10px;" data-role="id_weibo" id="weibo_47" class="" >
    <div class="all-wrap">
                    ...
                    <div class="op-tb op-top">
                        ...
                        <div class="pull-right show-operate-wrap">
                            ...
                            <div class="operate-box" >
                                                                <li data-weibo-id="47" title="删除" data-role="del_weibo">
                                        删除
                                    </li>                                                                <li><a data-type="ajax" data-url="/testsns/index.php?s=/home/addons/execute/_addons/report/_controller/report/_action/eject/param/type%3D%25E5%258A%25A8%25E6%2580%2581%252F%25E5%258A%25A8%25E6%2580%2581%26url%3DWeibo%252FIndex%252FweiboDetail%253Fid%253D47%26data%255Bweibo-id%255D%3D47.html" data-title="举报"  data-toggle="modal" >举报</a></li>
                            </div>
                        </div>
                    </div>
                    <div class="op-tb op-bottom">
                        <a data-hover="查看详情" class="wb-time" href="/testsns/index.php?s=/weibo/index/weibodetail/id/47.html">
                                                            2016-12-09 10:32                        </a>
                    </div>
                </div>
                            </div>
            <div class="content-info row">
                <p class='word-wrap'>我创建了一个新的群组【乖宝宝】：<a class="label label-badge badge-label" href="http://hugo.cn/testsns/index.php?s=/group/index/group/id/8.html" target="_blank"><i class="icon-link" title="http://hugo.cn/testsns/index.php?s=/group/index/group/id/8.html"></i></a></p>                 <div class="form-where">
                    <div class="where w-left">
                        <span>来自 网站端 </span>
                        <span></span>
                    </div>
                    <div class="where w-right  bottom-operate" data-weibo-id="47">
                                                <div class="col-xs-3" style="min-height: 1px"></div>
<div class="col-xs-3 operate-color">
     <a title="喜欢"
     class="support_btn" table="weibo" row="47" uid="100" jump="weibo/index/weibodetail">

            <i id="ico_like" class="icon-heart-empty"></i>

    <span id="support_Weibo_weibo_47_pos"><span id="support_Weibo_weibo_47">0</span> </span>
</a>
<script>
    bind_support();
</script></div>
<div class=" col-xs-3 operate-color" data-role="weibo_comment_btn"  data-weibo-id="47">
   <i class="os-icon-bubbles"></i> 0</div>
<div class="col-xs-3 operate-color">
        <a title="转发"  data-role="send_repost"  href="/testsns/index.php?s=/weibo/index/sendrepost/sourceId/47/weiboId/47.html"><i class="os-icon-share-alt"></i> 0</a>
</div>
                    </div>
                </div>
            </div>
    ...
    <div class="weibo-comment-list row" style="display: block;margin:0;"  data-weibo-id="47">
    <div class=" weibo-comment-block">
            ...
            <p class="comment-area">
                ...
                <input type="text" placeholder="评论（Ctrl+Enter）" id="text_47" rows="2" data-weibo-id="47"
                ...
                <a  data-role="do_comment" id="btn_47" data-weibo-id="47">
...
<div id="show_comment_47" class="weibo_comment_list" data-comment-count="0">
