<?php if (!defined('THINK_PATH')) exit();?><div style="max-width: 680px;margin-bottom: 10px;" data-role="id_weibo" id="weibo_50" class="" >
    <div class="all-wrap">
                    ...
                    <div class="op-tb op-top">
                        ...
                        <div class="pull-right show-operate-wrap">
                            ...
                            <div class="operate-box" >
                                                                <li data-weibo-id="50" title="删除" data-role="del_weibo">
                                        删除
                                    </li>                                                                <li><a data-type="ajax" data-url="/testsns/index.php?s=/home/addons/execute/_addons/report/_controller/report/_action/eject/param/type%3D%25E5%258A%25A8%25E6%2580%2581%252F%25E5%258A%25A8%25E6%2580%2581%26url%3DWeibo%252FIndex%252FweiboDetail%253Fid%253D50%26data%255Bweibo-id%255D%3D50.html" data-title="举报"  data-toggle="modal" >举报</a></li>
                            </div>
                        </div>
                    </div>
                    <div class="op-tb op-bottom">
                        <a data-hover="查看详情" class="wb-time" href="/testsns/index.php?s=/weibo/index/weibodetail/id/50.html">
                                                            2016-12-12 14:07                        </a>
                    </div>
                </div>
                            </div>
            <div class="content-info row">
                <p class='word-wrap'>我在群组【php讨论】里发表了一个新的帖子【地方】：<a class="label label-badge badge-label" href="http://hugo.cn/testsns/index.php?s=/group/index/detail/id/17" target="_blank"><i class="icon-link" title="http://hugo.cn/testsns/index.php?s=/group/index/detail/id/17"></i></a></p>                 <div class="form-where">
                    <div class="where w-left">
                        <span>来自 网站端 </span>
                        <span></span>
                    </div>
                    <div class="where w-right  bottom-operate" data-weibo-id="50">
                                                <div class="col-xs-3" style="min-height: 1px"></div>
<div class="col-xs-3 operate-color">
     <a title="喜欢"
     class="support_btn" table="weibo" row="50" uid="100" jump="weibo/index/weibodetail">

            <i id="ico_like" class="icon-heart-empty"></i>

    <span id="support_Weibo_weibo_50_pos"><span id="support_Weibo_weibo_50">0</span> </span>
</a>
<script>
    bind_support();
</script></div>
<div class=" col-xs-3 operate-color" data-role="weibo_comment_btn"  data-weibo-id="50">
   <i class="os-icon-bubbles"></i> 0</div>
<div class="col-xs-3 operate-color">
        <a title="转发"  data-role="send_repost"  href="/testsns/index.php?s=/weibo/index/sendrepost/sourceId/50/weiboId/50.html"><i class="os-icon-share-alt"></i> 0</a>
</div>
                    </div>
                </div>
            </div>
    ...
    <div class="weibo-comment-list row" style="display: block;margin:0;"  data-weibo-id="50">
    <div class=" weibo-comment-block">
            ...
            <p class="comment-area">
                ...
                <input type="text" placeholder="评论（Ctrl+Enter）" id="text_50" rows="2" data-weibo-id="50"
                ...
                <a  data-role="do_comment" id="btn_50" data-weibo-id="50">
...
<div id="show_comment_50" class="weibo_comment_list" data-comment-count="0">
