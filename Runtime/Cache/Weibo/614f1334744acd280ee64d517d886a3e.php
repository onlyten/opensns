<?php if (!defined('THINK_PATH')) exit();?><div style="max-width: 680px;margin-bottom: 10px;" data-role="id_weibo" id="weibo_79" class="" >
    <div class="all-wrap">
                    ...
                    <div class="op-tb op-top">
                        ...
                        <div class="pull-right show-operate-wrap">
                            ...
                            <div class="operate-box" >
                                                                                                                                <li><a data-type="ajax" data-url="/testsns/index.php?s=/home/addons/execute/_addons/report/_controller/report/_action/eject/param/type%3D%25E5%258A%25A8%25E6%2580%2581%252F%25E5%258A%25A8%25E6%2580%2581%26url%3DWeibo%252FIndex%252FweiboDetail%253Fid%253D79%26data%255Bweibo-id%255D%3D79.html" data-title="举报"  data-toggle="modal" >举报</a></li>
                            </div>
                        </div>
                    </div>
                    <div class="op-tb op-bottom">
                        <a data-hover="查看详情" class="wb-time" href="/testsns/index.php?s=/weibo/index/weibodetail/id/79.html">
                                                            2016-12-29 11:34                        </a>
                    </div>
                </div>
                            </div>
            <div class="content-info row">
                <p class="word-wrap"> <a class='label label-badge label-info'  href="/testsns/index.php?s=/weibo/topic/index/topk/10.html" target="_blank">#jiekou# </a> test</p>
<div class="" style="width: 433px;">
    <div class="my-simple-gallery photos" itemscope>
        <figure itemscope style="display:inline-block">
                        <a href="/testsns/Uploads/Picture/2016-12-29/148298246766820.png" itemprop="contentUrl" data-size="269x188" title="点击查看大图">
                            <img src="/testsns/Uploads/Picture/2016-12-29/148298246766820_1000_1000.png" itemprop="thumbnail" alt="Image description" style="margin-right: 7px;margin-bottom: 7px;max-height: 433px;max-width: 433px"/>
                        </a>
                    </figure>    </div>
</div>
<script>
    ...
    $(function(){
        initPhotoSwipeFromDOM('.my-simple-gallery');
                    ...
                    <div class="where w-left">
                        <span>来自 <strong>jiekou123</strong></span>
                        <span></span>
                    </div>
                    <div class="where w-right  bottom-operate" data-weibo-id="79">
                                                <div class="col-xs-3" style="min-height: 1px"></div>
<div class="col-xs-3 operate-color">
     <a title="喜欢"
     class="support_btn" table="weibo" row="79" uid="101" jump="weibo/index/weibodetail">

            <i id="ico_like" class="icon-heart-empty"></i>

    <span id="support_Weibo_weibo_79_pos"><span id="support_Weibo_weibo_79">0</span> </span>
</a>
<script>
    bind_support();
</script></div>
<div class=" col-xs-3 operate-color" data-role="weibo_comment_btn"  data-weibo-id="79">
   <i class="os-icon-bubbles"></i> 0</div>
<div class="col-xs-3 operate-color">
        <a title="转发"  data-role="send_repost"  href="/testsns/index.php?s=/weibo/index/sendrepost/sourceId/79/weiboId/79.html"><i class="os-icon-share-alt"></i> 0</a>
</div>
                    </div>
                </div>
            </div>
    ...
    <div class="weibo-comment-list row" style="display: block;margin:0;"  data-weibo-id="79">
    <div class=" weibo-comment-block">
            ...
            <p class="comment-area">
                ...
                <input type="text" placeholder="评论（Ctrl+Enter）" id="text_79" rows="2" data-weibo-id="79"
                ...
                <a  data-role="do_comment" id="btn_79" data-weibo-id="79">
...
<div id="show_comment_79" class="weibo_comment_list" data-comment-count="0">
