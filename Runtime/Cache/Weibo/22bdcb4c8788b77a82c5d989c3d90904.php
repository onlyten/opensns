<?php if (!defined('THINK_PATH')) exit();?><div style="max-width: 680px;margin-bottom: 10px;" data-role="id_weibo" id="weibo_76" class="" >
    <div class="all-wrap">
                    ...
                    <div class="op-tb op-top">
                        ...
                        <div class="pull-right show-operate-wrap">
                            ...
                            <div class="operate-box" >
                                                                                                                                <li><a data-type="ajax" data-url="/testsns/index.php?s=/home/addons/execute/_addons/report/_controller/report/_action/eject/param/type%3D%25E5%258A%25A8%25E6%2580%2581%252F%25E5%258A%25A8%25E6%2580%2581%26url%3DWeibo%252FIndex%252FweiboDetail%253Fid%253D76%26data%255Bweibo-id%255D%3D76.html" data-title="举报"  data-toggle="modal" >举报</a></li>
                            </div>
                        </div>
                    </div>
                    <div class="op-tb op-bottom">
                        <a data-hover="查看详情" class="wb-time" href="/testsns/index.php?s=/weibo/index/weibodetail/id/76.html">
                                                            2016-12-28 15:26                        </a>
                    </div>
                </div>
                            </div>
            <div class="content-info row">
                <p class="word-wrap">d</p>
    ...
    $(function(){
        initPhotoSwipeFromDOM('.my-simple-gallery');
                    ...
                    <div class="where w-left">
                        <span>来自 <strong>99999</strong></span>
                        <span></span>
                    </div>
                    <div class="where w-right  bottom-operate" data-weibo-id="76">
                                                <div class="col-xs-3" style="min-height: 1px"></div>
<div class="col-xs-3 operate-color">
     <a title="喜欢"
     class="support_btn" table="weibo" row="76" uid="101" jump="weibo/index/weibodetail">

            <i id="ico_like" class="icon-heart-empty"></i>

    <span id="support_Weibo_weibo_76_pos"><span id="support_Weibo_weibo_76">0</span> </span>
</a>
<script>
    bind_support();
</script></div>
<div class=" col-xs-3 operate-color" data-role="weibo_comment_btn"  data-weibo-id="76">
   <i class="os-icon-bubbles"></i> 0</div>
<div class="col-xs-3 operate-color">
        <a title="转发"  data-role="send_repost"  href="/testsns/index.php?s=/weibo/index/sendrepost/sourceId/76/weiboId/76.html"><i class="os-icon-share-alt"></i> 0</a>
</div>
                    </div>
                </div>
            </div>
    ...
    <div class="weibo-comment-list row" style="display: block;margin:0;"  data-weibo-id="76">
    <div class=" weibo-comment-block">
            ...
            <p class="comment-area">
                ...
                <input type="text" placeholder="评论（Ctrl+Enter）" id="text_76" rows="2" data-weibo-id="76"
                ...
                <a  data-role="do_comment" id="btn_76" data-weibo-id="76">
...
<div id="show_comment_76" class="weibo_comment_list" data-comment-count="0">
