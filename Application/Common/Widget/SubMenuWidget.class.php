...
class SubMenuWidget extends Controller
{
    ...
    public function renderw($menu_list, $current, $brand=null, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('brand', $new_brand);
        $this->display(T('Application://Common@Widget/menuw'));
    }

    public function renderww($menu_list, $current, $brand=null, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('brand', $new_brand);
        $this->display(T('Application://Common@Widget/menuww'));
    }
     ...
     */
    public function rendern($menu_list, $current, $brand=null, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('brand', $new_brand);
        $this->display(T('Application://Common@Widget/menun'));
    }
     ...
     * @return [type]            [description]
     */
    public function rendere($menu_list, $current, $brand=null, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('brand', $new_brand);
        $this->display(T('Application://Common@Widget/menue'));
    }
     ...
     * @return [type]            [description]
     */
    public function renders($menu_list, $current, $brand=null, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('brand', $new_brand);
        $this->display(T('Application://Common@Widget/menus'));
    }
}