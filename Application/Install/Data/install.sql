...
(1007, '_CONFIG_COPY_RIGHT', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>Copyright ©2013-2016 <a href="http://www.ourstu.com" target="_blank">嘉兴想天信息科技有限公司</a></p>', 0),
...
(255, '设置活跃度绑定的行为', 197, 0, 'Count/setActiveAction', 1, '', '会话管理', 0, '', ''),
(256, '会话设置', 74, 0, 'Message/config', 0, '', '会话管理', 0, '', ''),
(257, '频道编辑', 87, 0, 'Channel/customEdit', 0, '', '', 0, '', ''),
(258, '添加', 233, 0, 'Index/addTo', 0, '', '', 0, '', ''),
(259, '删除', 233, 0, 'Index/delTile', 0, '', '', 0, '', ''),
(260, '修改', 233, 0, 'Index/setTile', 0, '', '', 0, '', ''),
(261, '友情链接', 197, 0, 'SuperLinks/index', '0', '', '广告配置', '0', '', ''),
(262, '图片水印设置', 74, 0, 'Picture/config', 0, '', '图片管理', 1, '', ''),
(263, '上传水印图片', 262, 0, 'Picture/uploadWater', 1, '', '图片管理', 1, '', ''),
(264, '图片列表', 74, 0, 'Picture/pictureList', 0, '', '图片管理', 1, '', ''),
(265, '设置图片状态、删除图片', 264, 0, 'Picture/setStatus', 1, '', '图片管理', 1, '', ''),
(266,'敏感词列表', 113, 0, 'Sensitive/index', 0, '', '敏感词过滤', 0, '', ''),
(267,'敏感词设置', 113, 0, 'Sensitive/config', 0, '', '敏感词过滤', 0, '', ''),
(268,'批量添加', 113, 0, 'Sensitive/addMore', 0, '', '敏感词过滤', 0, '', ''),
(269,'新增、编辑敏感词', 266, 0, 'Sensitive/edit', 1, '', '', 0, '', ''),
(270,'设置敏感词状态', 266, 0, 'Sensitive/setStatus', 1, '', '', 0, '', ''),
(271, '自定义表情列表', 74, 0, 'Expression/iexpressionList', 0, '', '表情设置', 0, '', ''),
(272, '允许身份访问', 116, 0, 'Role/moduleRole', 0, '', '模块权限', 0, '', ''),
